...
namespace com.companyname.NavigationGraph5
{
                                ...
                                NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        // Preference variables - see OnDestinationChanged where it is checked
        ...
        {
            // Alternate handler for the Bottom Navigation fragments. Need to uncomment bottomNavigationView.ItemSelected in OnCreate - one or the other.
            if (!animateFragments)

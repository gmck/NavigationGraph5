...
using com.companyname.NavigationGraph5.Fragments;

namespace com.companyname.NavigationGraph5.Adapters
{
    public class HoldingFragmentViewPagerStateAdapter : FragmentStateAdapter
    {
        ...
        public HoldingFragmentViewPagerStateAdapter(FragmentManager fragmentManager, Lifecycle lifecylce, int itemCount) : base(fragmentManager, lifecylce)
        {

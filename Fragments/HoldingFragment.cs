...
using com.companyname.NavigationGraph5.Adapters;
...
namespace com.companyname.NavigationGraph5.Fragments
{
    public class HoldingFragment : Fragment
    {
        ...
        {
            // We had a crash because instead of clicking the back button, I clicked one close by pageindicators and then immediately clicked the back button again, but the Pager was already trying
            // to change fragments rather than exit . Big crash followed by the OBDService not being able to start again.
            // So this function prevents that from happening.
        ...
        #region OnCreateOptionsMenu - Deprecated - Not required anymore - now no need to clear the menu items
        public override void OnCreateOptionsMenu(IMenu menu, MenuInflater inflater)
        {
            // Don't want a menu on a viewPager HolderFragment
